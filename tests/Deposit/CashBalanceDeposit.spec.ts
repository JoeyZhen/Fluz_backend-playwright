...
test('Add funds to cash balance from card', async ({ request }) => {
...
test('Add funds to cash balance from card with invalid bank account', async ({ request }) => {
    try{
    const response = await request.post('https://power.staging.fluz.app/api/v1/cash-balance/deposit',{
      data: {
          "bank_account_id": "f5f7206a-a301-449d-9b28-051cf4dc2222",
          "bank_card_id": "de71e78d-143e-443b-adfc-ff581e6d8bec",
          "bt_device_data":{"correlation_id":"11e945ca5771789353ec1108fbbbb7bc"},
          "deposit_amount": 100,
          "deposit_type": "CASH_BALANCE",
